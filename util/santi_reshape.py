...
for current_pipeline_step in pipeline_steps:
    ...
    for i_file in list_files_for_reconstruction:
        ...
        #%% Grab the metadata that is the *same for every file*
        if i_file == 0:
            ...
            # Pull out: Center, Size, Pixel Resolution
            ...
            # Use the centers to align from left to right
            # Assumes they go left to right during DAQ
