...
data_path = r"D:\DATA\2025-01-16_GCaMP8s_tdtomato_mk302\mk302_2umpx_17p07hz_224pxby448px_2mroi_200mw_50to550umdeep_tdtomato_CavAB_00001\zplanes"
files = [x for x in Path("data").rglob("*.tif")]
movie = tifffile.imread("data/retina.tif")
