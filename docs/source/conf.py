...
# add these directories to sys.data_path here. If the directory is relative to the
# documentation root, use os.data_path.abspath to make it absolute, like shown here.
#
import os
import sys
